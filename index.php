...
// array
$fullName =array("Tikus", "Okalia", "Zeal");
var_dump($fullName);
echo "<br>";
...
function greetMe() {
    ...
    HomeAddress("NO.5" , "G&V");
    HomeAddress("NO.8", "Ugoani palace");
    
    echo "<br>";
    
    
    function HomeAddressLocation ($snumber, $sname, $location) {
        echo "$snumber street, $sname Asaba, $location state. <br>";
    }

    HomeAddressLocation("NO.5" , "G&V" , "Delta");
    HomeAddressLocation("NO.8", "Ugoani palace" , "Delta");
